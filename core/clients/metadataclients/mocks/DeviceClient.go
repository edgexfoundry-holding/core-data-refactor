...
func (_m *MockDeviceClient) Add(dev *models.Device) (string, error) {
	ret := _m.Called(dev)
...
func (_m *MockDeviceClient) Delete(id string) error {
	ret := _m.Called(id)
...
func (_m *MockDeviceClient) DeleteByName(name string) error {
	ret := _m.Called(name)
...
func (_m *MockDeviceClient) Device(id string) (models.Device, error) {
	ret := _m.Called(id)
...
func (_m *MockDeviceClient) DeviceForName(name string) (models.Device, error) {
	ret := _m.Called(name)
...
func (_m *MockDeviceClient) Devices() ([]models.Device, error) {
	ret := _m.Called()
...
func (_m *MockDeviceClient) DevicesByLabel(label string) ([]models.Device, error) {
	ret := _m.Called(label)
...
func (_m *MockDeviceClient) DevicesForAddressable(addressableid string) ([]models.Device, error) {
...
func (_m *MockDeviceClient) DevicesForAddressableByName(addressableName string) ([]models.Device, error) {
...
func (_m *MockDeviceClient) DevicesForProfile(profileid string) ([]models.Device, error) {
...
func (_m *MockDeviceClient) DevicesForProfileByName(profileName string) ([]models.Device, error) {
...
func (_m *MockDeviceClient) DevicesForService(serviceid string) ([]models.Device, error) {
...
func (_m *MockDeviceClient) DevicesForServiceByName(serviceName string) ([]models.Device, error) {
...
func (_m *MockDeviceClient) Update(dev models.Device) error {
	ret := _m.Called(dev)
...
func (_m *MockDeviceClient) UpdateAdminState(id string, adminState string) error {
...
func (_m *MockDeviceClient) UpdateAdminStateByName(name string, adminState string) error {
...
func (_m *MockDeviceClient) UpdateLastConnected(id string, time int64) error {
...
func (_m *MockDeviceClient) UpdateLastConnectedByName(name string, time int64) error {
...
func (_m *MockDeviceClient) UpdateLastReported(id string, time int64) error {
	ret := _m.Called(id, time)
...
func (_m *MockDeviceClient) UpdateLastReportedByName(name string, time int64) error {
	ret := _m.Called(name, time)
...
func (_m *MockDeviceClient) UpdateOpState(id string, opState string) error {
...
func (_m *MockDeviceClient) UpdateOpStateByName(name string, opState string) error {
